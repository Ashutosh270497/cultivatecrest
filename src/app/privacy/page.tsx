  ...
  return (
    <main id="main-content">
      ...
      <article className="shell legal-page">
        ...
        <section><h2>Retail purchases</h2><p>Retail purchases are completed on Amazon India. Amazon processes checkout, payment, delivery and account information under its own policies. CultivateCrest does not receive your payment-card details through this website.</p></section>
        ...
        <section><h2>Your questions</h2><p>To ask about information you shared directly with CultivateCrest, email <a href="mailto:info@cultivatecrest.in">info@cultivatecrest.in</a>.</p></section>
      </article>
    </main>
  );
}
