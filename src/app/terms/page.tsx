  ...
  return (
    <main id="main-content">
      ...
      <article className="shell legal-page">
        ...
        <section><h2>Product information</h2><p>We aim to keep product descriptions, pack details and imagery useful and accurate. Packaging, availability and displayed information may change. Always review the current pack label and marketplace listing before purchasing or consuming a product.</p></section>
        ...
        <section><h2>External checkout</h2><p>Amazon India and Flipkart are third-party services. Purchases, payments, delivery, cancellations and returns are governed by the terms and policies presented by the marketplace you select at the time of your order.</p></section>
